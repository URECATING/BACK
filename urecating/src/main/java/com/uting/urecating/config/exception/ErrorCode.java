...
public enum ErrorCode {
	...
	POST_JOIN_DELETE_USER_ERROR(400, "참가 삭제 실패, 참가 정보를 찾을 수 없습니다.", 42),
	...
	POST_USER_POST_ERROR(400, "사용자 작성 게시글 조회 실패, 게시글이 존재하지 않습니다", 430),
  	LIKE_POST_ERROR(400, " 좋아요 실패, 참가 정보를 찾을 수 없습니다.", 431),
	LIKE_POST_DELETE_ERROR(400, "좋아요 삭제 실패, 참가 정보를 찾을 수 없습니다.", 432),
	LIKE_POST_CHECK_ERROR(400, "좋아요 확인 검색 실패, 참가 정보를 찾을 수 없습니다.", 433),
	LIKE_POST_SEARCH_ERROR(400, "좋아요 목록 검색 실패, 참가 정보를 찾을 수 없습니다.", 434);
